...
- Task: 0 complete — waiting for user approval before Task 1
- Branch: feat/task-0-handoff
...
- [ ] Task 1 — Xcode SwiftUI project shell (iOS 17, RoomPlan linked, Info.plist)
- [ ] Task 2 — ScanStore + SavedScan with XCTest round-trip tests
